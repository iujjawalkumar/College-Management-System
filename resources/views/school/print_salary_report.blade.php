        ...
        <div class="row">
          <div class="col-12">
            <div class="callout callout-info">
              ...
              This page has been enhanced for printing. Click the print button at the bottom of the Salary Report to Print.
            </div>
            ...
            <div class="invoice p-3 mb-3" id="printableArea">
              ...
              <div class="row">
                <div class="col-12 table-responsive">
                    <br>
                    <center><h3><u>Salary Report from {{$from_date}} to {{$to_date}}</u></h3></center>
            ...
            <td>{{ App\Models\Employee_Model::getName($row->emp_id) }} 
            </td>
            <td>{{ App\Models\Employee_Model::getDesignation($row->emp_id) }} 
            </td>
              <td>{{ $row->salary}} <span>&#8377;</span>
              </td>
