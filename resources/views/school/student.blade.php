...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
            <h1>Fill Student Registration Form</h1>
          </div>
        <div class="col-sm-12">
...
<form method="post" action="{{url('school')}}/addstudent" enctype="multipart/form-data">
    @csrf
    @method('put')
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <select value="{{old('cclass')}}" class="form-control" name="stype" id="stype">
                      <option value="0">--Select (Old / New)--</option>
            ...
            <div class="form-group">
                ...
                <input type="date" name="ddate" value="{{old('ddate')}}" class="form-control" id="exampleInputEmail1" placeholder="Exp : Date">
              </div>
            @if ($errors->has('ddate'))
            ...
            <div class="form-group">
                ...
                <input type="text" name="father_name" value="{{old('father_name')}}" class="form-control" id="exampleInputEmail1" placeholder="Exp : Father Name">
              </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="mother_name" value="{{old('mother_name')}}" class="form-control" id="exampleInputEmail1" placeholder="Exp : Mother Name">
              </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="father_occupation" value="{{old('father_occupation')}}" class="form-control" id="exampleInputEmail1" placeholder="Exp : Father Occupation">
              </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="mother_occupation" value="{{old('mother_occupation')}}" class="form-control" id="exampleInputEmail1" placeholder="Exp : Mother Occupation">
              </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="education_of_father" value="{{old('education_of_father')}}" class="form-control" id="exampleInputEmail1" placeholder="Exp : Education of Father">
              </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="education_of_mother" value="{{old('education_of_mother')}}" class="form-control" id="exampleInputEmail1" placeholder="Exp : Education of Mother">
              </div>
   ...
   <!-- general form elements -->
          <div class="card card-info" align="left">
            ...
            <div class="form-group">
                ...
                <input type="text" name="adm_no" value="{{old('adm_no')}}" class="form-control" id="exampleInputEmail1" placeholder="Exp : Application / Admission / Form No.">
              </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="mobile2" value="{{old('mobile2')}}" class="form-control" id="exampleInputEmail1" placeholder="Exp : Mobile No. 2">
              </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="email" value="{{old('email')}}" class="form-control" id="exampleInputEmail1" placeholder="Exp : E-Mail Address">
              </div>
            @if ($errors->has('email'))
            ...
            <div class="form-group">
                ...
                <input type="text" name="aadhar_card" value="{{old('aadhar_card')}}" class="form-control" id="exampleInputEmail1" placeholder="Exp : Aadhar Card. No.">
              </div>
            ...
            <div class="form-group">
              ...
              <select name="gender" value="{{old('gender')}}" class="form-control" id="exampleInputEmail1" placeholder="Exp : Gender">
          ...
          @endif
            ...
            <div class="form-group">
                ...
                <select name="religion" value="{{old('religion')}}" class="form-control" id="exampleInputEmail1" placeholder="Exp : Religion">
            ...
            <br>
              ...
              <div class="card-footer" align="center">
                  ...
                  <input type='submit' name="upload" class="btn btn-info" value='Click here for Register'/>
              </div>
            </form>
          </div>
          <!-- /.card -->
