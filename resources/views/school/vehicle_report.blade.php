  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Filter Vehicle Report by Date & Driver</h1>
          </div>
          <div class="col-sm-6">
      ...
      <div class="card">
        ...
        <div class="col-md-6" style="float:none;margin:auto;">
            ...
            <div class="card card-success">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{url('school')}}/get_vehicle_report" method="get">
                @csrf
            ...
            <div class="form-group">
                ...
                <select value="{{old('cclass')}}" class="form-control" name="emp" id="emp">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-success swalDefaultSuccess">Get Vehicle Report &#8377;</button>
                </div>
              </form>
            </div>
        </div>
