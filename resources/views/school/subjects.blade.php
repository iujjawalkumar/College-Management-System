...
@section('main-container')
  ...
  @endif
          ...
          <div class="col-md-6" style="float:none;margin:auto;">
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Add Subjects in Class</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
            ...
            <div class="form-group">
                ...
                <select value="{{old('section')}}" class="form-control" name="section" id="section">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="subject" value="{{old('subject')}}" class="form-control" id="exampleInputEmail1" placeholder="Exp : Hindi, English, etc..">
                  </div>
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">All the Subjects Records in the Database</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <td>{{$da->subject}}
              ...
              <td width="200px"> 
              <a class="btn btn-app" onclick="return confirm('Are you sure?')" href="subject_delete/{{$da->id}}">
