  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Filter Salary Report by Date</h1>
          </div>
          <div class="col-sm-6">
      ...
      <div class="card">
        ...
        <div class="col-md-6" style="float:none;margin:auto;">
            ...
            <div class="card card-success">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{url('school')}}/get_salary_report" method="get">
                @csrf
            ...
            @endif
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-success swalDefaultSuccess">Get Salary Report &#8377;</button>
                </div>
              </form>
            </div>
        </div>
