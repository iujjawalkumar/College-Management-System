  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Exam Schedule - {{ App\Models\Exam_List_Model::getName($exam_id) }}</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-md-6" style="float:none;margin:auto;">
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Create Exam Schedule by Subjects & Date</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{url('school')}}/addexam_schedule/{{$exam_id}}" method="POST">
                @csrf
                @method('put')
                <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="date" name="ddate" value="{{old('ddate')}}" class="form-control">
                <input type="hidden" name="exam_id" value="{{$exam_id}}" class="form-control">
              </div>
    
                <div class="card-footer">
                  <button type="submit" class="btn btn-success swalDefaultSuccess">Click to Create</button>
                  <a class="btn btn-info" href="{{url('school')}}/exam">Back to Exam</a>
                </div>
              </form>
            </div>
            <!-- /.card -->
        ...
        <div class="card-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <td>{{$da->ddate}}
              ...
              <td width="200px"> 
              <a class="btn btn-app" onclick="return confirm('Are you sure?')" href="exam_schedule_delete/{{$da->id}}">
