      ...
      <div class="container-fluid">
          ...
          <div class="col-md-6" style="float:none;margin:auto;">
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Update E-Library Books Details</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{url('school')}}/elibrary_update/{{$data2->id}}" method="POST" enctype="multipart/form-data">
                @csrf
            ...
            <input type="file" class="form-control" name="doc_file" value="{{$data2->doc_file}}">
        ...
        @endif
                ...
                <div class="card-footer">
                  ...
                  <a class="btn btn-info" href="../elibrary">Back</a>
                </div>
              </form>
            </div>
            <!-- /.card -->
