        ...
        <div class="row">
          ...
          <div class="col-md-6" style="float:none;margin:auto;">
            ...
            <div class="card card-success">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{url('school')}}/employee_update/{{$data2->id}}" method="POST">
                @csrf
                <div class="card-body">
              ...
              @endif
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="email" value="{{$data2->email}}" class="form-control" id="exampleInputEmail1" placeholder="Exp : info@softnickindia.com">
                  </div>
                @if ($errors->has('email'))
