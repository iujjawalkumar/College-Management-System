  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Update Vehicle Route Records</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-md-6" style="float:none;margin:auto;">
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Update Vehicle Route</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{url('school')}}/routes_update/{{$data2->id}}" method="POST">
                @csrf
              ...
              @endif
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="route_name" value="{{$data2->route_name}}" class="form-control" id="exampleInputEmail1" placeholder="Exp : Routes">
                  </div>
                ...
                <div class="card-footer">
                  ...
                  <a class="btn btn-info" href="../routes">Back</a>
                </div>
              </form>
            </div>
            <!-- /.card -->
