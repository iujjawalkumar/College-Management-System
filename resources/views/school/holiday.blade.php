...
@section('main-container')
  ...
  @endif
          ...
          <div class="col-md-6" style="float:none;margin:auto;">
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Add Holiday Details by Date</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              @endif
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="title" value="{{old('title')}}" class="form-control" placeholder="Exp : Diwali, Holi, Eid, etc..">
                  </div>
                @if ($errors->has('title'))
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">All the Holiday Records in the Database</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <td>{{$da->ddate}}
              ...
              <td width="200px"> 
              <a class="btn btn-app" onclick="return confirm('Are you sure?')" href="holiday_delete/{{$da->id}}">
