...
class ASalary extends Controller
{
    public function index($id)
    {
        ...
        $salary=Salary_Model::all()->where('emp_id',$id);
     
        return view('admin.pay_salary', ['data'=>$data,'data2'=>$data2,'salary'=>$salary,'emp_salary'=>$emp_salary]);
    }
    ...
    public function view($id)
    {
        ...
        $data4 = Salary_Model::all()->where('emp_id',$id);

        return view('admin.pay_salary_slip', ['data'=>$data,'data2'=>$data2,'data3'=>$data3,'data4'=>$data4]);
    }
    ...
    public function salary_report()
    {
        ...
        return view('admin.salary_report', ['data'=>$data]);
    }
    ...
    public function get_salary_report(Request $request)
    {
        ...
        \DB::statement("SET SQL_MODE=''");
            $salary_data=Salary_Model::whereBetween('created_at', [$from_date, $to_date])->where('sid', $sid)->get();
      

        return view('admin.print_salary_report', ['data'=>$data,'salary_data'=>$salary_data,'from_date'=>$from_date,'to_date'=>$to_date]);
